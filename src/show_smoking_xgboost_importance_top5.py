...
def visualize_smoking_xgboost_top5(model_path, data_path, output_path):
    """
    저장된 흡연 XGBoost 모델을 불러와 상위 5개 변수 중요도를 시각화하고 저장합니다.
    """
    ...
    plt.title('XGBoost 흡연 예측 모델: 상위 5개 변수 중요도', fontsize=14)
...
if __name__ == '__main__':
    visualize_smoking_xgboost_top5(
        model_path='results/smoking/smoking_model_xgboost.joblib',
        data_path='analysis_data.csv',
        output_path='results/smoking/xgboost_feature_importance_top5.png'
    )
