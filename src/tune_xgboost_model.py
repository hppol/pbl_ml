...
def tune_xgboost_model():
    """
    XGBoost 모델을 훈련하고 GridSearchCV로 최적 하이퍼파라미터를 찾습니다.
    """
    print("--- XGBoost 모델 훈련 및 튜닝 시작 ---")
    ...
    # 3. scale_pos_weight 계산 (데이터 불균형 처리를 위함)
    ...
    # 7. 최적 모델 저장
    print("7. 최적화된 XGBoost 모델 저장 중...")
    output_dir = "results"
    os.makedirs(output_dir, exist_ok=True)
    model_path = os.path.join(output_dir, 'smoking_model_xgboost.joblib')
