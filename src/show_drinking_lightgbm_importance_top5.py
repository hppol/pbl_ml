...
def visualize_drinking_lightgbm_top5(model_path, data_path, output_path):
    """
    저장된 고위험 음주 LightGBM 모델을 불러와 상위 5개 변수 중요도를 시각화하고 저장합니다.
    """
    ...
    plt.title('LightGBM 고위험 음주 예측 모델: 상위 5개 변수 중요도', fontsize=14)
...
if __name__ == '__main__':
    visualize_drinking_lightgbm_top5(
        model_path='results/drinking/drinking_model_lightgbm.joblib',
        data_path='analysis_data.csv',
        output_path='results/drinking/lightgbm_drinking_importance_top5.png'
    )
