...
def visualize_xgboost_importance(model_path, data_path, output_path):
    """
    저장된 XGBoost 모델을 불러와 변수 중요도를 시각화하고 저장합니다.
    """
    # 한글 폰트 설정
    ...
    plt.title('XGBoost 흡연 예측 모델의 변수 중요도')
...
if __name__ == '__main__':
    visualize_xgboost_importance(
        ...
        output_path='results/smoking/xgboost_feature_importance_horizontal.png'
    )
